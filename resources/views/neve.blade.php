...
<div id="recent-posts">
	...
	<ul>
		...
		?>
	  <li class='first'>
		<h3><a href='#'><?=  "{$namer1}"; ?></a></h3>
			<p><strong><?= "{$datsr1}"; ?></strong><?= "{$Textsr1}";?><a href='#'>More…</a></p>
	 </li>
	<li>
			<h3><a href='#'><?= "{$namer2}"; ?></a></h3>
			<p><strong><?= "{$datsr2}";?></strong><?= "{$Textsr2}";?><a href='#'>More…</a></p>
		</li>
		<li>
		<h3><a href='#'> <?= "{$namer3}"; ?></a></h3>
			<p><strong><?= "{$datsr3}";?></strong>

	<?= "${Textsr3}";?><a href='#'>More…</a></p>
	</li>
